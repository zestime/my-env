...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-searchindex', 'indent-blankline.nvim', 'FixCursorHold.nvim', 'open-browser.vim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
